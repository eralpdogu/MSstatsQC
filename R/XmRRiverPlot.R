#' A function to create river plot to aggregate results from X and mR charts
#'
...
XmRRiverPlot <- function(data = NULL, L=1, U=5, listMean=NULL, listSD=NULL) {
  if(is.null(data))
    return()
