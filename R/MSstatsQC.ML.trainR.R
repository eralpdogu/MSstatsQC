...
MSstatsQC.ML.trainR <- function(guide.set,
    ...
    message(c("Constructed the RF model"))
    ...
    message(c("Performance"))
    message(c(
        training_AUC = hit1@metrics$AUC,
        validation_AUC = hit2@metrics$AUC,
        testing_AUC = hit3@metrics$AUC
    ))
    message(c("Hyperparameters of the best model"))
    message(c(
        Number_of_trees = rf_model@allparameters$ntrees,
