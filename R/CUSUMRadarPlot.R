#' A function to create radar plot to aggregate results from CUSUMm and CUSUMv control charts
#'
...
#' CUSUMRadarPlot(data = sampleData)
#' CUSUMRadarPlot(data = sampleData,
...
CUSUMRadarPlot <- function(data = NULL, L = 1, U = 5, listMean = NULL, listSD = NULL) {
  if(is.null(data))
    return()
