...
```{r, eval=FALSE}
# Retention time >> mean is 34.5 and standard deviation is 1.0
XmRChart(S9Site54, "LVNELTEFAK", metric = "RetentionTime", type="mean", selectMean = 34.5, selectSD = 1)
```
...
XmRChart(S9Site54, "LVNELTEFAK", metric = "RetentionTime", type="mean", L = 1, U = 20)
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
XmRChart(S9Site54, "LVNELTEFAK", metric = "RetentionTime", type="dispersion", L = 1, U = 20)
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
CUSUMChart(S9Site54, "LVNELTEFAK", metric = "RetentionTime", type="mean", L=1, U=20, ytitle="CUSUMm")
CUSUMChart(S9Site54, "LVNELTEFAK", metric = "TotalArea", type="mean", L=1, U=20, ytitle="CUSUMm")
CUSUMChart(S9Site54, "LVNELTEFAK", metric = "RetentionTime", type="dispersion", L=1, U=20, ytitle="CUSUMv")
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
XmRChart(S9Site54, "TAAYVNAIEK", metric = "RetentionTime", type="mean", L = 1, U = 20)
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
XmRChart(S9Site54, "YSTDVSVDEVK", metric = "RetentionTime", type="mean", L = 1, U = 20)
